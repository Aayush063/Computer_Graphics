...
def scaling (x1,y1,x2,y2):
    ...
    y11=y1*sy
    y22=y2*sy
    pygame.draw.line(screen,"YELLOW",(x11,y11),(x22,y22),2)
...
def rotation (x1,y1,x2,y2):
    ...
    y11=x1*math.sin(math.radians(45))+y1*math.cos(math.radians(45))
    y22=x2*math.sin(math.radians(45))+y2*math.cos(math.radians(45))
    pygame.draw.line(screen,"PINK",(x1,y1),(x22,y22),2)
...
screen.fill(BLACK)
scaling(250,650,500,500)
rotation(400,200,700,200)
translate(100,100,100,300)
pygame.display.flip()
